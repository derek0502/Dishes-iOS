//
//  OrderDetail+Remote.h
//  AnyPresence SDK
//

/*!
 @header OrderDetail+Remote
 @abstract Remote category for OrderDetail class
 */

#import "OrderDetail.h"

/*!
 @category OrderDetail (Remote)
 @abstract Adds remote CRUD capabilities to OrderDetail.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface OrderDetail (Remote)
