...
/*!
 @header Product+Remote
 @abstract Remote category for Product class
 */

#import "Product.h"

/*!
 @category Product (Remote)
 @abstract Adds remote CRUD capabilities to Product.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Product (Remote)
